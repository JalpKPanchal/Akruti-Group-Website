      ...
      <div className="contact-page">
        ...
        <section className="contact-hero-dark d-flex flex-column justify-content-center align-items-center text-center">
          ...
          <p className="contact-hero-desc">
            We are always on the lookout to work with passionate individuals and companies.<br />
          ...
          <Row className="gy-5">
            ...
            <Col md={6}>
              <div className="glass-card p-4 shadow-lg animate-fade">
                ...
                <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <Button variant="outline-light" type="submit" className="rounded-pill px-4 contact-hero-btn">
                    Submit
                  </Button>
            ...
            <Col md={6}>
              <div className="glass-card p-4 shadow-lg animate-fade delay-1">
                ...
                <p><strong>Email:</strong> <a href="mailto:akrutiengineering72@gmail.com" className="text-decoration-underline text-dark">akrutiengineering72@gmail.com</a></p>
                <iframe
                  title="map"
