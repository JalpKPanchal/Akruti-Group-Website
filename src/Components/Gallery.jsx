          ...
          <div className="row align-items-center mb-4">
            ...
            <div className="col-lg-6 text-lg-start">
              <p className="description">
                Our innovative technologies, clear focus on the needs of our
                clients, and 1,210 dedicated employees energize society. Let’s
                make tomorrow different today!
              </p>
              <Link to="/gallerypage" className="button button--transparent">
