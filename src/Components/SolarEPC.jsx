            ...
            <div className="row">
              <div className="col-md-5">
                ...
                <p className="epc-description mt-4">
                  ...
                  monitoring, our expert approach guarantees superior
                  performance, reliability, and efficiency. Partner with Akruti
                  for end-to-end renewable energy solutions that power
                  sustainable success.
                </p>
              </div>
            ...
            <div className="row mt-4">
              ...
              <div className="col-md-4 mb-4">
                ...
                <p className="process-description">
                  ...
                  stability evaluation, mechanical structure design, and
            ...
            <div className="row align-items-center mb-5">
              <div className="col-md-5">
                ...
                <p className="benefit-description">
                  ...
                  most suitable locations. Following the creation of a
                  preliminary site plan, we propose capital investment options
                  and support the drafting of comprehensive contracts upon
                  onboarding.
                </p>
              </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-7">
                ...
                <p className="Akruti-description">
                  Akruti Green leverages its expertise in solar energy to
                  deliver large-scale solar power solutions. To expand our solar
                  energy portfolio across India, we have secured grid
                  connectivity approvals for solar parks in multiple states. We
                  have also initiated the process of identifying and evaluating
                  suitable sites nationwide for the commissioning of new solar
                  projects.
                </p>
              </div>
            </div>
