...
export default function SolarIC() {
  useEffect(() => {
    ...
    <main className="solarwind-page">
      ...
      <section className="black_hero" data-aos="fade-up" data-aos-delay="80">
        <div className="normal_leptop_container container">
          <div className="hero-careear">
            <h1
              className="career-headings text-align-right"
              data-aos="fade-up"
              data-aos-delay="140"
            >
            ...
            <div
              className="career_content w-richtext"
              data-aos="fade-up"
              data-aos-delay="320"
            >
              <p>
      ...
      <section className="container normal_leptop_container" id="solar_hybrid">
        <div className="careers-about d-flex align-items-center flex-wrap">
          <div
            className="ca-content col-lg-6"
            data-aos="fade-right"
            data-aos-delay="120"
          >
            <h2 className="_1-heading">
              What is <strong>Wind Solar Hybrid System?</strong>
            </h2>
          ...
          <div
            className="ca-images col-lg-6 text-center"
            data-aos="fade-left"
            data-aos-delay="220"
          >
            <img
      ...
      <section className="section-7">
        <div className="normal_leptop_container container">
          <div className="careers-3-about row">
            <div
              className="c3a-text-content col-lg-6"
              data-aos="fade-up"
              data-aos-delay="120"
            >
            ...
            <div
              className="c3a-content col-lg-6"
              data-aos="fade-up"
              data-aos-delay="240"
            >
              <div className="c3a-card bp0 d-flex flex-column">
                <div className="c3a-wrapper d-flex align-items-center">
                  <div className="c3a-circle">
                    <img
                      src="https://cdn.prod.website-files.com/64dbc131328758d2f8cb2f35/66ddd7e7d72eb33f27e0dffe_Ok.svg"
                      alt="ok"
                    />
                  </div>
              ...
              <img
                className="c3a-image mt-3"
                src="https://cdn.prod.website-files.com/64dbc131328758d2f8cb2f35/66ddd7e7d72eb33f27e0e01f_Icon%20C3.svg"
                alt="icon"
                loading="lazy"
              />
            </div>
      ...
      <section className="section_program">
        <div className="normal_leptop_container container">
          <div className="program_wrap d-flex align-items-start flex-wrap">
            <div
              className="program_left-box col-lg-4"
              data-aos="fade-right"
              data-aos-delay="120"
            >
              <h2 className="_1-heading white title_left">
                Process for <strong>Hybrid System</strong>
              </h2>
            </div>

            <div
              className="program_right-box col-lg-8"
              data-aos="fade-left"
              data-aos-delay="200"
            >
              <div className="program_content-box">
                <div className="program_text">
                  ...
                  <p className="text-size-regular-2 text-color-gray text-weight-medium">
      ...
      <div className="process_section">
        <div className="normal_leptop_container container">
          <div className="title_wrap text-center mb-4">
            <h2
              className="_1-heading title_center"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <strong>Why Wind Solar Hybrid?</strong>
            </h2>
          </div>
          ...
          <div className="process">
            {/* Step 1 */}
            <div
              className="process_card d-flex align-items-center flex-wrap"
              data-aos="fade-right"
              data-aos-delay="140"
            >
              <div className="process_details col-md-5">
                ...
                <div className="w-richtext">
                  <p>
                    Combines wind and solar to produce more energy than
                    standalone systems.
                  </p>
                </div>
              </div>
              ...
              <div className="process_image_wrap col-md-5 text-center">
                <img
                  className="image-40 img-fluid"
                  src="https://cdn.prod.website-files.com/64dbc131328758d2f8cb2f35/677d127a6cac65f16ea74aba_Increased%20Energy%20Yield.webp"
            ...
            {/* Step 2 */}
            <div
              className="process_card_02 d-flex align-items-center flex-wrap"
              data-aos="fade-left"
              data-aos-delay="260"
            >
              <div className="process_image_wrap col-md-5 text-center">
                <img
                  className="process_image img-fluid"
                  src="https://cdn.prod.website-files.com/64dbc131328758d2f8cb2f35/677d127ab3436c1a1014a817_Reduced%20Intermittency.webp"
            ...
            >
              <div className="process_details col-md-5">
                ...
                <div className="w-richtext">
                  <p>
                    Maximizes the use of available land and resources, offering
              ...
              <div className="process_image_wrap col-md-5 text-center">
                <img
                  className="image-40 img-fluid"
                  src="https://cdn.prod.website-files.com/64dbc131328758d2f8cb2f35/677d127a21fb32c62c6e6556_Cost-Effective.webp"
                  alt="Cost Effective"
                />
              </div>
            </div>
      ...
      <div className="full-page-wrapper">
        <div className="s-scroll">
          <div
            className="s-scroll-box-wrapper"
            data-aos="fade-up"
            data-aos-delay="120"
          >
            <div className="content-outer-wrapper">
              <div className="ca-bedge">
                <div className="text-7">
                  Expansion of the Renewable Park Business
                </div>
              </div>
              <h2 className="_1-heading">
                <strong>Solar Park</strong> Programme
              </h2>
              <p className="main-p">
                We are expanding our portfolio of solar energy parks by applying
                to respective state nodal agencies under the Solar Parks
                Programme. We intend to develop renewable energy parks in
                high-potential states across India including Tamil Nadu,
          ...
          <div
            className="s-scroll-box-wrapper img"
            data-aos="fade-left"
            data-aos-delay="260"
          >
        ...
        <div className="s-scroll">
          ...
          >
            <div className="content-outer-wrapper">
              ...
              <h2 className="_1-heading">
                <strong>Hybrid System</strong> Design
              </h2>
              <p className="main-p">
                Our team develops innovative and cost-effective green energy
                solutions aimed at optimizing the performance ratio of our
                projects.
              </p>
            </div>
          </div>
        ...
        <div className="s-scroll">
          ...
          >
            <div className="content-outer-wrapper">
              ...
              <h2 className="_1-heading">
                <strong>Grid Integration &amp;</strong> Management
              </h2>
              <p className="main-p">
                We help facilitate grid connectivity by liaisoning with
                government agencies to obtain permits for integrating solar
                power systems with existing electricity supply lines.
              </p>
            </div>
          </div>
      ...
      <section className="container normal_leptop_container">
        <div className="section-5">
          <div className="w-layout-grid">
            <h2 className="_1-heading" data-aos="fade-up" data-aos-delay="120">
              Hear from our <strong>Customers</strong>
            </h2>

            <div
              className="testimonial-card mt-3"
              data-aos="fade-up"
              data-aos-delay="220"
            >
              <div className="d-flex align-items-start">
                <img
                  ...
                  src="https://cdn.prod.website-files.com/64dbc131328758d2f8cb2f35/66d2ab4bcb0b824defe86bee_john-carter-team-member-brix-templates-avatar-picture.jpg"
                  alt="John Carter"
                />
                <div>
                  <div className="fw-bold">
                    MD at India’s biggest commercial automobile manufacturing
                    plant
                  </div>
                  <p className="mt-2">
            ...
            >
              <div className="d-flex align-items-start">
                <img
                  className="avatar-image"
                  src="https://cdn.prod.website-files.com/64dbc131328758d2f8cb2f35/66d2ab4acb0b824defe86b5b_sohphie-moore-team-member-brix-templates-avatar-picture.jpg"
                  alt="Sophie Moore"
                />
                <div>
                  <div className="fw-bold">
            ...
            >
              <div className="d-flex align-items-start">
                <img
                  className="avatar-image"
                  src="https://cdn.prod.website-files.com/64dbc131328758d2f8cb2f35/66d2ab4bcb0b824defe86bbb_matt-cannon-team-member-brix-templates-avatar-picture.jpg"
                  alt="Matt Cannon"
                />
                <div>
                  <div className="fw-bold">
      ...
      {/* APPLY CTA */}
      <div
        className="apply_now_cta normal_leptop_container container"
        data-aos="fade-up"
        data-aos-delay="140"
      >
        <div className="center-content-vertically d-flex align-items-center justify-content-between flex-wrap p-4">
          ...
          <Link
            Link
            to="/contact"
            className="button-5 bg-dark-blue d-inline-block"
          >
