          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              ...
              <p className="section-text">
                ...
                wind and solar resources often complement each other. At Akruti,
                we design and build custom hybrid systems that optimize energy
                production while reducing the impact of weather fluctuations.
              </p>
            </div>
            <div className="col-md-6">
              <img
